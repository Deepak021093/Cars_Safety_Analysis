...
The folder named "Codes"ù contain the R codes to be able to generate the html outputs, and the folder named "Final report"ù contains the final report to be generated in pdf format. 
